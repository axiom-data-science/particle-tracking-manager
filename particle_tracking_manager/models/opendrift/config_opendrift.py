...
class OpenDriftConfig(TheManagerConfig):
    ...
    interpolator_filename: str | None = Field(
        None,
...
class ObjectTypeEnum(str, Enum):
    ...
    LIFE_RAFT_15_50_PERSON_CANOPY_GENERAL = (
        ">15-50 person capacity, deep ballast system, canopy, general (mean values)"
    )
    LIFE_RAFT_15_50_PERSON_CANOPY_NO_DROGUE_LIGHT = (
    ...
    LIFE_RAFT_NO_BALLAST_GENERAL = (
        "Life-raft, no ballast (NB) system, general (mean values)"
    )
    LIFE_RAFT_NO_BALLAST_NO_CANOPY_NO_DROGUE = (
        ">Life-raft, no ballast system, no canopy, no drogue"
    )
    LIFE_RAFT_NO_BALLAST_NO_CANOPY_WITH_DROGUE = (
        ">Life-raft, no ballast system, no canopy, with drogue"
    )
    LIFE_RAFT_NO_BALLAST_WITH_CANOPY_NO_DROGUE = (
        ">Life-raft, no ballast system, with canopy, no drogue"
    )
    LIFE_RAFT_NO_BALLAST_WITH_CANOPY_WITH_DROGUE = (
    ...
    LIFE_RAFT_4_6_PERSON_NO_BALLAST_WITH_CANOPY_NO_DROGUE = (
        "Life-raft, 4-6 person capacity, no ballast, with canopy, no drogue"
    )
    EVACUATION_SLIDE_WITH_LIFE_RAFT = (
        "Evacuation slide with life-raft, 46 person capacity"
    )
    SURVIVAL_CRAFT_SOLAS_HARD_SHELL = (
    ...
    SURVIVAL_CRAFT_OVATEK_HARD_SHELL_4_MAN_FULLY_NO_DROGUE = (
        ">Survival Craft - Ovatek Hard Shell Life Raft, 4 man, fully loaded, drogued"
    )
    SURVIVAL_CRAFT_OVATEK_HARD_SHELL_7_MAN_FULLY_NO_DROGUE = (
    ...
    FISHING_VESSEL_JAPANESE_SIDE_STERN_TRAWLER = (
...
class OilTypeEnum(str, Enum):
    ...
    ARABIAN_EXTRA_LIGHT_STAR_ENTERPRISE_AD00040 = (
        "ARABIAN EXTRA LIGHT, STAR ENTERPRISE (AD00040)"
    )
    ...
    AVIATION_GASOLINE_100LL_STAR_ENTERPRISE_AD00092 = (
        "AVIATION GASOLINE 100LL, STAR ENTERPRISE (AD00092)"
    )
    ...
    COOK_INLET_DRIFT_RIVER_TERMINAL_AD00269 = (
        "COOK INLET, DRIFT RIVER TERMINAL (AD00269)"
    )
    ...
    ELECTRICAL_INSULATING_OIL_VIRGIN_AD00346 = (
        "ELECTRICAL INSULATING OIL (VIRGIN) (AD00346)"
    )
    ...
    FUEL_OIL_NO1_AVJET_A_STAR_ENTERPRISE_AD00403 = (
        "FUEL OIL NO.1 (AVJET A), STAR ENTERPRISE (AD00403)"
    )
    FUEL_OIL_NO1_DIESELHEATING_FUEL_PETRO_STAR_AD00404 = (
        "FUEL OIL NO.1 (DIESEL/HEATING FUEL), PETRO STAR (AD00404)"
    )
    ...
    FUEL_OIL_NO2_DIESEL_STAR_ENTERPRISE_AD00431 = (
        "FUEL OIL NO.2 (DIESEL), STAR ENTERPRISE (AD00431)"
    )
    ...
    KUWAIT_CRUDE_OIL_LITERATURE_VALUES_AD00631 = (
        "KUWAIT CRUDE OIL (LITERATURE VALUES) (AD00631)"
    )
    ...
    LUBRICATING_OIL_AUTO_ENGINE_OIL_VIRGIN_AD00697 = (
        "LUBRICATING OIL (AUTO ENGINE OIL, VIRGIN) (AD00697)"
    )
    ...
    PREMIUM_UNLEADED_GASOLINE_STAR_ENTERPRISE_AD00913 = (
        "PREMIUM UNLEADED GASOLINE, STAR ENTERPRISE (AD00913)"
    )
    QUA_IBOE_PHILLIPS_AD00924 = "QUA IBOE, PHILLIPS (AD00924)"
    RAGUSA_AD00932 = "RAGUSA (AD00932)"
    RANGELAND_SOUTH_LIGHT_AND_MEDIUM_AD00935 = (
        "RANGELAND-SOUTH LIGHT AND MEDIUM (AD00935)"
    )
    ...
    TRADING_BAY_OFFSHORE_COOK_INLET_AD01118 = (
        "TRADING BAY (OFFSHORE COOK INLET) (AD01118)"
    )
    ...
    UNLEADED_INTERM_GASOLINE_STAR_ENTERPRISE_AD01137 = (
        "UNLEADED INTERM GASOLINE, STAR ENTERPRISE (AD01137)"
    )
    ...
    WC_BLOCK_45_BEACH_CONDENSATE_PHILLIPS_AD01162 = (
        "WC BLOCK 45 BEACH-CONDENSATE, PHILLIPS (AD01162)"
    )
    ...
    MARINE_DIESEL_F_76_MANCHESTER_FUEL_AD01215 = (
        "MARINE DIESEL F-76, MANCHESTER FUEL (AD01215)"
    )
    ...
    WEST_TEXAS_INTERMEDIATE_OIL__GAS_AD01223 = (
        "WEST TEXAS INTERMEDIATE, OIL & GAS (AD01223)"
    )
    ...
    SOLVENT_NEUTRAL_OIL_320_STAR_ENTERPRISE_AD01412 = (
        "SOLVENT NEUTRAL OIL 320, STAR ENTERPRISE (AD01412)"
    )
    ROSSIIELF_RUSSIAN_JOINT_STOCK_CO_AD01413 = (
        "ROSSIIELF, RUSSIAN JOINT STOCK CO (AD01413)"
    )
    ...
    MAIN_PASS_49_CONDENSATE_SHELL_OIL_AD01473 = (
        "MAIN PASS 49 CONDENSATE, SHELL OIL (AD01473)"
    )
    ...
    VENTURA_SHELL_TAYLOR_LEASE_SHELL_OIL_AD01492 = (
        "VENTURA SHELL TAYLOR LEASE, SHELL OIL (AD01492)"
    )
    ...
    JET_A_1__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01500 = (
        "JET A-1,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01500)"
    )
    DUAL_PURPOSE_KEROSINE__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01501 = (
        "DUAL PURPOSE KEROSINE,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01501)"
    )
    MCKEE_BLEND_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01507 = (
        "MCKEE BLEND, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01507)"
    )
    MAUI_F_SAND_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01508 = (
        "MAUI F SAND, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01508)"
    )
    MCKEE_BLEND_50_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01510 = (
        "MCKEE BLEND 50%, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01510)"
    )
    MCKEE_BLEND_25_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01511 = (
        "MCKEE BLEND 25%, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01511)"
    )
    MCKEE_BLEND_10_NGAT_1_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01512 = (
        "MCKEE BLEND 10% NGAT-1, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01512)"
    )
    MCKEE_BLEND_10_NGAT_2_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01513 = (
        "MCKEE BLEND 10% NGAT-2, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01513)"
    )
    MCKEE_BLEND_10_NGAT_3_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01514 = (
        "MCKEE BLEND 10% NGAT-3, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01514)"
    )
    HANDIL_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01515 = (
        "HANDIL, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01515)"
    )
    BARROW_ISLAND_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01517 = (
        "BARROW ISLAND, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01517)"
    )
    BRASS_RIVER_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01519 = (
        "BRASS RIVER, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01519)"
    )
    DUBAI_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01520 = (
        "DUBAI, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01520)"
    )
    MURBAN_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01521 = (
        "MURBAN, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01521)"
    )
    MAUI_B_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01522 = (
        "MAUI B, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01522)"
    )
    KUTUBU_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01524 = (
        "KUTUBU, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01524)"
    )
    GRIFFIN_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01525 = (
        "GRIFFIN, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01525)"
    )
    MIRI_LIGHT_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01528 = (
        "MIRI LIGHT, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01528)"
    )
    SYNGAS_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01529 = (
        "SYNGAS, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01529)"
    )
    LABUAN_MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01530 = (
        "LABUAN, MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01530)"
    )
    OMAN__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01533 = (
        "OMAN,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01533)"
    )
    THEVENARD__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01535 = (
        "THEVENARD,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01535)"
    )
    WIDURI__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01536 = (
        "WIDURI,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01536)"
    )
    KHAFJI__MARITIME_SAFETY_AUTHORITY_OF_NEW_ZEALAND_AD01537 = (
        "KHAFJI,  MARITIME SAFETY AUTHORITY OF NEW ZEALAND (AD01537)"
    )
    ...
    BUNKER_C_FUEL_OIL_IRVING_WHALE_AD01622 = (
        "BUNKER C FUEL OIL (IRVING WHALE) (AD01622)"
    )
    ...
    NEWFOUNDLAND_OFFSHORE_BURN_EXPERIMENT_AD01758 = (
        "NEWFOUNDLAND OFFSHORE BURN EXPERIMENT (AD01758)"
    )
    ...
    MOTOR_GASOLINE_PREMIUM_UNLEADED_SHELL_REFINING_PTY__AD01776 = (
        "MOTOR GASOLINE-PREMIUM UNLEADED, SHELL REFINING PTY  (AD01776)"
    )
    MOTOR_GASOLINE_UNLEADED_SHELL_REFINING_PTY__AD01777 = (
        "MOTOR GASOLINE-UNLEADED, SHELL REFINING PTY  (AD01777)"
    )
    MOTOR_GASOLINE_LEADED_SHELL_REFINING_PTY__AD01778 = (
        "MOTOR GASOLINE-LEADED, SHELL REFINING PTY  (AD01778)"
    )
    AUTOMOTIVE_DIESEL_FUEL_SHELL_REFINING_PTY__AD01779 = (
        "AUTOMOTIVE DIESEL FUEL, SHELL REFINING PTY  (AD01779)"
    )
    AVIATION_TURBINE_FUEL_SHELL_REFINING_PTY__AD01786 = (
        "AVIATION TURBINE FUEL, SHELL REFINING PTY  (AD01786)"
    )
    WHITE_SPIRIT_SHELL_REFINING_PTY__AD01800 = (
        "WHITE SPIRIT, SHELL REFINING PTY  (AD01800)"
    )
    ...
    ALASKA_NORTH_SLOPE_PUMP_STATION_9_BP_AD01850 = (
        "ALASKA NORTH SLOPE-PUMP STATION #9, BP (AD01850)"
    )
    QATAR_NORTH_FIELD_CONDENSATE_NFR_1_MOBIL_AD01851 = (
        "QATAR NORTH FIELD CONDENSATE (NFR-1), MOBIL (AD01851)"
    )
    ...
    ARABIAN_EXTRA_LIGHT_MOBIL_OIL_AUSTRALIA_AD01882 = (
        "ARABIAN EXTRA LIGHT, MOBIL OIL AUSTRALIA (AD01882)"
    )
    BASRAH_LIGHT_MOBIL_OIL_AUSTRALIA_AD01884 = (
        "BASRAH LIGHT, MOBIL OIL AUSTRALIA (AD01884)"
    )
    ...
    KUTUBU_LIGHT_MOBIL_OIL_AUSTRALIA__AD01889 = (
        "KUTUBU LIGHT, MOBIL OIL AUSTRALIA  (AD01889)"
    )
    QATAR_LAND_MOBIL_OIL_AUSTRALIA__AD01891 = (
        "QATAR LAND, MOBIL OIL AUSTRALIA  (AD01891)"
    )
    QATAR_MARINE_MOBIL_OIL_AUSTRALIA_AD01892 = (
        "QATAR MARINE, MOBIL OIL AUSTRALIA (AD01892)"
    )
    THAMMAMA_MOBIL_OIL_AUSTRALIA__AD01893 = "THAMMAMA, MOBIL OIL AUSTRALIA  (AD01893)"
    UPPER_ZAKUM_MOBIL_OIL_AUSTRALIA__AD01894 = (
        "UPPER ZAKUM, MOBIL OIL AUSTRALIA  (AD01894)"
    )
    ...
    SEPINGGAN_YAKIN_MIXED_OIL__GAS_AD01929 = (
        "SEPINGGAN-YAKIN MIXED, OIL & GAS (AD01929)"
    )
    SAHARAN_BLEND_OIL__GAS_AD01930 = "SAHARAN BLEND, OIL & GAS (AD01930)"
    RAINBOW_LIGHT_AND_MEDIUM_OIL__GAS_AD01938 = (
        "RAINBOW LIGHT AND MEDIUM, OIL & GAS (AD01938)"
    )
    ...
    ALASKA_NORTH_SLOPE_MIDDLE_PIPELINE_AD01987 = (
        "ALASKA NORTH SLOPE (MIDDLE PIPELINE) (AD01987)"
    )
    ALASKA_NORTH_SLOPE_NORTHERN_PIPELINE_AD01988 = (
        "ALASKA NORTH SLOPE (NORTHERN PIPELINE) (AD01988)"
    )
    ALASKA_NORTH_SLOPE_SOCSEX_AD01989 = "ALASKA NORTH SLOPE (SOCSEX) (AD01989)"
    ALASKA_NORTH_SLOPE_SOUTHERN_PIPELINE_AD01990 = (
        "ALASKA NORTH SLOPE (SOUTHERN PIPELINE) (AD01990)"
    )
    ALBA_AD01991 = "ALBA (AD01991)"
    ALBERTA_SWEET_MIXED_BLEND_PETAWAWA_AD01993 = (
        "ALBERTA SWEET MIXED BLEND (PETAWAWA) (AD01993)"
    )
    ALBERTA_SWEET_MIXED_BLEND_REFERENCE_2_AD01994 = (
        "ALBERTA SWEET MIXED BLEND (REFERENCE #2) (AD01994)"
    )
    ALBERTA_SWEET_MIXED_BLEND_REFERENCE_3_AD01995 = (
        "ALBERTA SWEET MIXED BLEND (REFERENCE #3) (AD01995)"
    )
    ...
    DIESEL_FUEL_OIL_SOUTHERN_USA_1994_AD02083 = (
        "DIESEL FUEL OIL (SOUTHERN USA 1994) (AD02083)"
    )
    DIESEL_FUEL_OIL_SOUTHERN_USA_1997_AD02084 = (
        "DIESEL FUEL OIL (SOUTHERN USA 1997) (AD02084)"
    )
    ...
    ELECTRICAL_INSULATING_OIL_VOLTESSO_35_AD02098 = (
        "ELECTRICAL INSULATING OIL (VOLTESSO 35) (AD02098)"
    )
    ...
    FLUID_CATALYTIC_CRACKER_HEAVY_CYCLE_OIL_AD02125 = (
        "FLUID CATALYTIC CRACKER HEAVY CYCLE OIL (AD02125)"
    )
    FLUID_CATALYTIC_CRACKER_LIGHT_CYCLE_OIL_AD02126 = (
        "FLUID CATALYTIC CRACKER LIGHT CYCLE OIL (AD02126)"
    )
    FLUID_CATALYTIC_CRACKER_MEDIUM_CYCLE_OIL_AD02127 = (
        "FLUID CATALYTIC CRACKER MEDIUM CYCLE OIL (AD02127)"
    )
    ...
    FUEL_OIL_NO2_HIGH_AROMATIC_CONTENT_HEATING_OIL_AD02139 = (
        "FUEL OIL NO.2 (HIGH AROMATIC CONTENT HEATING OIL) (AD02139)"
    )
    ...
    INTERMEDIATE_FUEL_OIL_180_SOCSEX_AD02182 = (
        "INTERMEDIATE FUEL OIL 180 (SOCSEX) (AD02182)"
    )
    INTERMEDIATE_FUEL_OIL_300_AD02183 = "INTERMEDIATE FUEL OIL 300 (AD02183)"
    INTERMEDIATE_FUEL_OIL_300_SOCSEX_AD02184 = (
        "INTERMEDIATE FUEL OIL 300 (SOCSEX) (AD02184)"
    )
    ...
    LUBRICATING_OIL_AIR_COMPRESSOR_NEW_AD02220 = (
        "LUBRICATING OIL (AIR COMPRESSOR) NEW (AD02220)"
    )
    LUBRICATING_OIL_AIR_COMPRESSOR_USED_AD02221 = (
        "LUBRICATING OIL (AIR COMPRESSOR) USED (AD02221)"
    )
    ...
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_1_AD02275 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #1 (AD02275)"
    )
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_12_AD02276 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #12 (AD02276)"
    )
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_15_AD02277 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #15 (AD02277)"
    )
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_4_AD02278 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #4 (AD02278)"
    )
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_5_AD02279 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #5 (AD02279)"
    )
    NEWFOUNDLAND_OFFSHORE_BURN_EXP_SAMPLE_7_AD02280 = (
        "NEWFOUNDLAND OFFSHORE BURN EXP SAMPLE #7 (AD02280)"
    )
    ...
    DIESEL_FUEL_OIL_NO2_BONDED_TESORO_AD02436 = (
        "DIESEL FUEL OIL NO.2 (BONDED), TESORO (AD02436)"
    )
    ...
    BACHAQUERO_DELAWARE_RIVER_CITGO_AD02482 = (
        "BACHAQUERO-DELAWARE RIVER, CITGO (AD02482)"
    )
    ...
    AMSA_Average_Very_Low_Sulfur_Fuel_Oil_VLSFO_AD02580 = (
        "AMSA Average Very Low Sulfur Fuel Oil (VLSFO) (AD02580)"
    )
    ...
    VLSFO_WRG_oil_DMZ_RMA_quality_SINTEF_AD02609 = (
        "VLSFO WRG oil, DMZ-RMA quality (SINTEF) (AD02609)"
    )
    ULSFO_Heavy_Distillate_Marine_ECA_50_SINTEF_AD02610 = (
        "ULSFO Heavy Distillate Marine ECA 50 (SINTEF) (AD02610)"
    )
    Ultra_Low_Sulphur_Fuel_Oil_ULSFO_RMA_quality_oil_SINTEF_AD02611 = (
        "Ultra Low Sulphur Fuel Oil (ULSFO), RMA-quality oil (SINTEF) (AD02611)"
    )
    ...
    Mississippi_Canyon_Block_807_2002_EC00647 = (
        "Mississippi Canyon Block 807 [2002] (EC00647)"
    )
    ...
    Sweet_Synthetic_Crude_Oil_2015b_EC02681 = (
        "Sweet Synthetic Crude Oil [2015b] (EC02681)"
    )
    Sweet_Synthetic_Crude_Oil_2015a_EC02695 = (
        "Sweet Synthetic Crude Oil [2015a] (EC02695)"
    )
    ...
    Bunker_C_MV_Manolis_2015_May_operation_EC02932 = (
        "Bunker C MV Manolis 2015-May operation (EC02932)"
    )
    ...
    HEAVY_DISTILLATE_MARINE_ECA_50_2017_NO00121 = (
        "HEAVY DISTILLATE MARINE ECA 50 2017 (NO00121)"
    )
    ...
    GENERIC_INTERMEDIATE_FUEL_OIL_180_AD04009 = (
        "GENERIC INTERMEDIATE FUEL OIL 180 (AD04009)"
    )
    GENERIC_INTERMEDIATE_FUEL_OIL_300_AD04010 = (
        "GENERIC INTERMEDIATE FUEL OIL 300 (AD04010)"
    )
