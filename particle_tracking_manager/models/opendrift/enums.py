...
# oil = [(oil.id, oil.name) for oil in dirjs.oils(limit=1300)]
...
class ModifyOilTypeJsonSchema(GenerateJsonSchema):
    ...
    def generate(self, schema, mode='validation'):
        ...
        for name, value in OilTypeEnum.__members__.items():
            enum_values.append({
                "const": name,  # The unique ID (enum name)
                "title": value  # The human-readable title which might be duplicated (enum value)
            })
